...
class OrderResourceIT {
    ...
    private static final String DEFAULT_EMAIL_ADDRESS = "(a{qR@\\SSSS";
    private static final String UPDATED_EMAIL_ADDRESS = "xX*x@\\SS";
    ...
    private static final QcStatus DEFAULT_QC_STATUS = QcStatus.ACCEPTED;
    private static final QcStatus UPDATED_QC_STATUS = QcStatus.REJECTED;
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getEmailAddress()).isEqualTo(DEFAULT_EMAIL_ADDRESS);
        assertThat(testOrder.getSku()).isEqualTo(DEFAULT_SKU);
        ...
        assertThat(testOrder.getQcStatus()).isEqualTo(DEFAULT_QC_STATUS);
    }
    ...
    void putNewOrder() throws Exception {
        ...
        assertThat(testOrder.getEmailAddress()).isEqualTo(UPDATED_EMAIL_ADDRESS);
        assertThat(testOrder.getSku()).isEqualTo(UPDATED_SKU);
        ...
        assertThat(testOrder.getQcStatus()).isEqualTo(UPDATED_QC_STATUS);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderId(UPDATED_ORDER_ID).itemName(UPDATED_ITEM_NAME).qcStatus(UPDATED_QC_STATUS);
